...
- Likely files:
  ...
  - `scripts/install-minimal.sh` (if it stages files that `install-whats-next.sh` expects)
  - `templates/cursor_rules/requirements_rule.md` (ensure it exists/ships appropriately)
  - Tests under `tests/` or installer coverage harness under `coverage/`
