...
> **Note**: This is a VibeSafe thinking tool, not a required process. Use it when you need to understand who's affected by your project.

## Purpose

This pattern helps identify all relevant stakeholders for a software project and understand their needs, priorities, and influence. Proper stakeholder identification is essential for gathering comprehensive requirements and ensuring the project meets the needs of all affected parties.

## When to Use This Pattern

✅ **Use when**:
- Starting a new project or major feature
- Requirements seem incomplete or biased toward one group
- Conflicts arise between different user needs
- You need to prioritize competing requirements

❌ **Don't use when**:
- Stakeholders are obvious and already well-understood
- You're defining implementation details (that's CIP territory)
- You're organizing development tasks (that's backlog territory)
...
Use stakeholder identification to inform requirements (WHAT):

```
Tenet (WHY) → [Stakeholder Pattern] → Requirements (WHAT) → CIPs (HOW) → Backlog (DO)
```

**Example Flow**:
1. **Tenet**: "User Autonomy Over Prescription" (WHY we care)
2. **Pattern**: Apply Stakeholder Identification
3. **Stakeholders Identified**:
   - AI developers (primary users)
   - Project managers (decision makers)
   - End users of AI-assisted projects (indirect)
4. **Requirements** (WHAT):
   - REQ-XXX: "Users can customize VibeSafe to their workflow"
   - REQ-XXX: "Clear visibility into project status for managers"
5. **CIPs** (HOW):
...
6. *Ensure requirements represent all affected parties*, not just the loudest voices
