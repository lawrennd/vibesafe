...
6. *Documentation Compression*: A systematic workflow (WHY→WHAT→HOW→DO→DOCUMENT) that consolidates closed CIPs and completed implementations into permanent, accessible formal documentation. See [Compression Guide](docs/source/compression-guide.md), [CIP-0013](cip/cip0013.md), and [REQ-000E](requirements/req000E_documentation-synchronization.md).
