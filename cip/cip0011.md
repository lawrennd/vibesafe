...
- [ ] **Add "Deferred" status for CIPs**: Allow CIPs to be marked as postponed/blocked
  - [ ] Update validation script to allow `Deferred` in CIP status list
  - [ ] Add `blocked_by` field (optional, CIP ID that blocks this one)
  - [ ] Add `superseded_by` field (optional, CIP ID that replaces this one)
