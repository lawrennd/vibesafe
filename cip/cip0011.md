...
VibeSafe currently has three components that need better integration and sustainability:

1. **Requirements System**: Currently too complex (ai-requirements framework with prompts, patterns, integrations, examples, guidance)
2. **Tenets System**: Works well but lacks a maintenance/review process to keep them relevant
3. **Summary Tools**: Need a unified way to understand project status across all components

This CIP proposes simplifying these systems while adding better tooling and sustainability practices.
...
├── REQ-001_feature-name.md
├── REQ-002_another-feature.md
...
[VibeSafe Patterns - Reference when needed]
                ↓
         Requirements → CIP → Backlog Task → Implementation
                ↓
         Tenets (inform all decisions)
```
