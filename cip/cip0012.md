...
- [ ] Create `.ai/context/` directory structure in templates
- [ ] Update `install-minimal.sh` to install to both paths
- [ ] Test dual-path installation

### Phase 2: Generic Naming
- [ ] Rename `generate_tenet_cursor_rules()` → `generate_ai_context_files()`
- [ ] Update `combine_tenets.py` CLI flags
- [ ] Update internal comments and documentation

### Phase 3: Documentation
- [ ] Add "Framework Independence" section to README.md
- [ ] Update all `.mdc` files to be platform-neutral
- [ ] Create platform-specific setup guides (optional)

### Phase 4: Testing
- [ ] Write installation tests for dual-path support
