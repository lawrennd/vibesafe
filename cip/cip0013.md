...
status: "Proposed"
related_requirements: []  # Future: REQ-000E (Documentation Synchronization)
...
**Which requirements does this CIP address?** Future REQ-000E (Documentation Synchronization). Currently addresses the "Phase 3: Finalization" guidance in VibeSafe General Development Guidelines.
...
- [ ] Add `--compression-check` flag to `whats-next` script
- [ ] Show "X CIPs awaiting compression" in suggested next steps
- [ ] Generate compression backlog tasks automatically
...
Future requirement REQ-000E: "Formal documentation stays synchronized with closed CIPs"

## Implementation Status

- [ ] Phase 0: Add compression metadata to CIP format
